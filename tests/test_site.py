...
""",
    ...
    def test_build_index_html_respects_url_style(self) -> None:
        with TemporaryDirectory() as tmpdir:
            ...
            dir_config = WikiConfig(vault={"inputs": [wiki]}, site={"url_style": "dir"}, config_root=root)
            ...
            file_config = WikiConfig(vault={"inputs": [wiki]}, site={"url_style": "file"}, config_root=root)
