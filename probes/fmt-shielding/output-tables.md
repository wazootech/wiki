...
A nested fence: four backticks wrapping a triple fence, which is how the docs wiki shows fenced YAML inside a document.
...
Now a SPARQL block wrapped in a four-backtick fence, with trailing whitespace inside the query text.
