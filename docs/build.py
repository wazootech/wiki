"""Build the docs wiki with the full Wikipedia-themed layout.

Usage: python docs/build.py [--output-dir _site]
"""
...
def build(output_dir: Path) -> None:
    ...
    # Strip leading slash for filesystem path under output_dir
    ...
    # All wiki content lives under output_dir/{base_path}/
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build docs wiki with Wikipedia theme")
