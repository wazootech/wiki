...
| [wiki-camunda-template](https://github.com/wazootech/wiki-camunda-template)   | Camunda process/rules knowledge base with BPMN, DMN, FEEL, workers, connectors, and governance dashboards ([#186](https://github.com/wazootech/wiki/issues/186))                                            |
