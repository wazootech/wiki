...
For **frontmatter-only validation** without the full semantic toolchain, see [Braincheck](Braincheck.md). For a **standardized agent workspace** (typed graph, loop, blast-radius review), see [Vivary](Vivary.md).
