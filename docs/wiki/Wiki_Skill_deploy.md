...
Canonical skill file: [`skills/wiki-deploy/SKILL.md`](../../skills/wiki-deploy/SKILL.md) in the [wiki-cli](https://github.com/wazootech/wiki) repository. Workflow templates mirror [`.github/workflows/deploy-pages.yml`](../../.github/workflows/deploy-pages.yml): [uv monorepo](../../skills/wiki-deploy/references/workflow-template-uv.yml), [pip standalone](../../skills/wiki-deploy/references/workflow-template-pip.yml), plus an [alignment checklist](../../skills/wiki-deploy/references/alignment-checklist.md).
