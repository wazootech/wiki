...
**Procedural knowledge** is "knowing how": skills, workflows, validation rules, and repeatable processes. It contrasts with [Declarative_Knowledge](Declarative_Knowledge.md) ("knowing what")—facts, classifications, and relationships stored as data.
