...
In a semantic [Personal Knowledge](Personal_Knowledge.md) vault, procedural knowledge often lives in tooling rather than prose alone:

- [Wiki Skills](Wiki_Skills.md) — agent `SKILL.md` workflows for install, scaffold, and vault audit (repository `skills/`, not indexed as vault pages)
