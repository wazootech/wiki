...
The `version` case is also known: Deno reports the cutover version `0.1.24`,
while the pinned Python oracle remains at `0.1.23`.

The first behavioral divergence is **`check-micro`**, and it is irreducible rather
